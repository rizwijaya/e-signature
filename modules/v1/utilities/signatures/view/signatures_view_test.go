...
func Test_signaturesView_MySignatures(t *testing.T) {
	...
	test := []struct {
	...
	}{
		{
			...
			beforeTest: func(serviceSignature *m_serviceSignature.MockService, serviceUser *m_serviceUser.MockService) {
				serviceSignature.EXPECT().GetMySignature("rizwijaya", "6395e69cebc81f0ea1f6b75d", "Rizqi Wijaya").Times(1)
	...
	test := []struct {
		...
		},
		{
			...
			beforeTest: func(serviceSignature *m_serviceSignature.MockService, serviceUser *m_serviceUser.MockService) {
				...
				serviceSignature.EXPECT().GetDocument("84637c537106cb54272b66cda69f1bf51bd36a4c244e82419f9d725e15d9cc4b", "0xC443cfFc795f21493c68911f8F7Dbe6Ccb8B3682").Return(models.DocumentBlockchain{
					Document_id:    "63820321334838fe2021b0fe",
					Creator:        common.HexToAddress("0xC443cfFc795f21493c68911f8F7Dbe6Ccb8B3682"),
					Creator_string: "0xC443cfFc795f21493c68911f8F7Dbe6Ccb8B3682",
